...
public class ChangePasswordDialog extends JDialog {
	 ...
	 * Create the dialog.
	 */
	public ChangePasswordDialog(MainFrame mainFrame, Account account, BankDAO dao) {
		...
		{
			JLabel lblCurrentUsername = new JLabel("Current Password:");
		...
		}
		{
			...
			contentPanel.add(tfCurrentPassword, gbc_tfCurrentUsername);
			tfCurrentPassword.setColumns(10);
		}
		{
			JLabel lblNewUsername = new JLabel("New Password:");
		...
		}
		{
			...
			contentPanel.add(tfNewPassword, gbc_tfNewUsername);
	...
	private void change() {
		...
		}else if(!currentPassword.equals(account.getPassword())) {
			errorMessage("Current Password is incorrect");
		}else if(!newPassword.equals(confirmPassword)) {
			errorMessage("New passwords do NOT match");
		}else {
			account.changePassword(newPassword);
			dao.updatePassword(account, currentPassword);
			close();
		}
	}
